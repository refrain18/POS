...
<h2 class="judul">Edit Laporan Manajemen Bulanan</h2>
<form name="myForm" onsubmit="return validateForm()" method="post" action="?mod=laporan_manajemen_bulanan&hal=lmb_update">
