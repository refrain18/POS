...
<form name="formTambahPegawai" onsubmit="return validateForm(this)" method="POST" action="?mod=pegawai&hal=insert_pg" enctype="multipart/form-data">
   ...
   <div class="form-group">
      <label for="tmpt_lahir"><small style="color:red;">*</small>Tempat Lahir</label>   
      <div class="input"><input type="text" id="tmpt_lahir" name="tmpt_lahir" required></div> 
   </div>

   <div class="form-group">
      <label for="tgl_lahir"><small style="color:red;">*</small>Tanggal Lahir</label>   
      <div class="input"><input type="date" id="tgl_lahir" name="tgl_lahir" required></div> 
   </div>

   <div class="form-group">
      <label for="level"><small style="color:red;">*</small>Level</label>   
      <div class="input">
   ...
   <div class="form-group">
      <label for="no_hp"><small style="color:red;">*</small>No.HP</label>   
   ...
   <div class="form-group">
      <label for="date_joined"><small style="color:red;">*</small>Tanggal Bergabung</label>   
   ...
   <div class="form-group">
      <label for="pass"><small style="color:red;">*</small>Password</label>   
      <div class="input"><input type="password" id="pass" name="password" minlength="8" maxlength="16" required></div> 
   </div>
   <div class="form-group"></br>
        <label><small style="color:red;">*</small>Status</label>
        <span>
