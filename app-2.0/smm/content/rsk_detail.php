...
<h2 class="judul">Detail Rekap Stok Keluar Bulanan Salon Mumtaza</h2>
<div class="label_123">
    <label class="l_namaProduk" for="">Nama Produk :</label>
    <br>
    <label class="l_tsm" for="">Total Stok Keluar :</label>
    <label class="l_bulan_rsm" for="">Bulan :</label>
</div>
<a class="cetak" href="?hal=rsk_cetak_detail">Cetak</a>
<br>
