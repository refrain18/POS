...
<form name="myForm" onsubmit="return validateForm()" method="post" action="?hal=sm_insert" enctype="multipart/form-data">
   ...
   <div class="form-group">
      <label for="stok_masuk">Junlah Stok Masuk</label>   
